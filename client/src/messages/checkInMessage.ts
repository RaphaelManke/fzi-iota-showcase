...
export class CheckInMessage {
  public static fromTrytes(input: Trytes): CheckInMessage {
    return fromTrytes(input, ['vehicleId', 'trits'], ['validFrom', 'date'], ['validUntil', 'date']);
  }
  ...
  constructor(public readonly vehicleId: Int8Array, public readonly tripChannelIndex: number,
              ...
              public readonly reservationRate: number, public readonly validFrom?: Date,
              public validUntil?: Date, public reservationRoot?: Hash,
              public readonly vehicleInfo?: VehicleInfo, public password?: Trytes) {
  }
}
